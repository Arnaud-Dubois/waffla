...
// 		lastItem = $('li:last-child');
	...
	var light = $('#light'),
		...
		tl
			.to(cake, 0.8, {y:-30, scale:1.06,transformOrigin:"50% 50%", autoAlpha:1, ease:Power3.easeOut})
			.to(candle, 0.3, {y:-40, autoAlpha:1})
			.set(light, {y:-40})
			.to(light, 0.3, {scale:1.06,transformOrigin:"50% 50%",autoAlpha:1, ease:Bounce.easeIn}, 2)
